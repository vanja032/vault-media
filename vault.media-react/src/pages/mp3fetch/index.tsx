...
import MP3FetchPanel from "@/components/mp3fetch/MP3FetchPanel";
import React, { ReactElement, useEffect, useState } from "react";
import ResultRow from "@/components/global/ResultRow";

export default function MP3Fetch() {
  ...
  return (
    <>
      ...
      <main>
        <Navbar name="mp3" />
        <MP3FetchPanel onFetch={addContent} onChange={changeContent} />
